...
KnownParameters= [9.1152, 7.98194]
GuessParameters= [9,8]
...
check=SimulateSingleIsothermalDataPoint(KnownParameters, 1.556148, 392.15, 29.8, 0.253, testtime, ReactorVol, DeadVol)
...
def SaveFile(filenameNoExtension, experimentdataset):
    ...
    return
SaveFile('enthought_Opt_10000ALowerflow75notlower5', NewExperimentA)
SaveFile('enthought_Opt_10000BLowerflow75notlower5', NewExperimentB)
'''
