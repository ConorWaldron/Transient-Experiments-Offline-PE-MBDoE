...
FactorialParameters= [9.257, 8.444]
GuessParameters= [9,8]
...
SulfuricAcidData=ImportData('Dec 14D Python Format Corrected.xlsx')
...
testtimeresidence=Times(29.8, 0.253, ReactorVol, DeadVol, testtime)
'''
...
def SimulateSingleTvaryingDataPoint(theta, FeedConc, T0, alphaT, vo, alphaV, tmSec, Vr, Vd):
    ...
    CEthylBenzoate[0]=FeedConc-CBenzoicAcid[0]
    return CBenzoicAcid[0], CEthylBenzoate[0]
#CheckGeneratedSol=SimulateSingleTvaryingDataPoint(FactorialParameters, 1.5, 413.15, 0.25, 100, 1, testtime, ReactorVol, DeadVol)
